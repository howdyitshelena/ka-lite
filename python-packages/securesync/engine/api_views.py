...
def device_upload(data, session):
    ...
    try:
        ...
        result = { "error": str(e), "saved_model_count": 0 }
...
def model_upload(data, session):
    ...
    try:
        ...
        print "Exception uploading models (in api_views): %s, %s, %s" % (e.__class__.__name__, str(e), e.args)
        result = { "error": str(e), "saved_model_count": 0 }
...
def model_download(data, session):
    ...
    try:
        ...
        print "Exception downloading models (in api_views): %s, %s, %s" % (e.__class__.__name__, str(e), e.args)
